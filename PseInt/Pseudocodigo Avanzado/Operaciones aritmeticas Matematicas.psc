	...
	Mientras (men <> 5)
		...
		Segun men Hacer
			1:
				Mientras (sum <> 3)
					Borrar Pantalla
					Escribir 'Elija el nivel de operaciones que desea hacer'
					...
					Segun sum Hacer
						1:
							Borrar Pantalla
							Escribir '--------------- Te dare tres ejercicios para realizar ---------------'
							Escribir '--------- Elije la respuesta escribiendo el inciso correcto ---------'
							...
							Escribir ""
							Escribir "------------------------------------------------"
							Escribir 'Presione una tecla para volver al menu de sumas'
							Esperar Tecla
							Borrar Pantalla
						2:
							Borrar Pantalla
				...
				Mientras (res <> 3)
					...
					Segun res Hacer
						1:
							...
							Escribir ""
							Escribir "------------------------------------------------"
							Escribir 'Presione una tecla para volver al menu de restas'
							Esperar Tecla
							Borrar Pantalla
						2:
							Borrar Pantalla
				...
				Mientras (mult <> 3)
					...
					segun mult Hacer
						1:
							...
							Escribir ""
							Escribir "----------------------------------------------------------"
							Escribir 'Presione una tecla para volver al menu de multiplicaciones'
							Esperar Tecla
							Borrar Pantalla
						2:
							Borrar Pantalla
			...
			4:
				Mientras (div <> 3)
					Borrar Pantalla
					Escribir '----------------------- Ha elegido las divisiones -----------------------'
					Escribir 'Elija el nivel de operaciones que desea hacer'
					...
					Segun div Hacer
						1:
							...
							Escribir ""
							Escribir "------------------------------------------------"
							Escribir 'Presione una tecla para volver al menu de divisiones'
							Esperar Tecla
							Borrar Pantalla
						2:
							Borrar Pantalla
